...
function PBRf()
    ...
    app = {}
    app.window = Jkr.CreateWindow(Engine.i, "Hello", vec2(900, 480), 3, vec2(1920, 1080))
    ...
    local function Update()
        ...
        app.Objects[DamagedHelmetObjectIndex].mRotation =
            app.Objects[DamagedHelmetObjectIndex].mRotation:Rotate_deg(0.1, vec3(0, 1, 0))
    end
    ...
    while not e:ShouldQuit() do
        ...
        -- w:BeginDeferredDraws(1, 1, 1, 1, 1)
        -- w:EndDeferredDraws()
        -- w:ExecuteDeferredComposition(app.deferredComposition3D, app.world3dDeferred)
        ...
        w:BeginDraws(app.WindowClearColor.x, app.WindowClearColor.y, app.WindowClearColor.z,
            app.WindowClearColor.w, 1)
        ...
        if (frameCount % 10 == 0) then
            w:SetTitle("Samprahar Frame delta -> " .. delta)
        end
