function Objects()
          ...
          Engine.AddObject(app.Objects, skyboxId, -1, app.Uniforms.SimpleSkyboxUniform.index,
          ...
          app.world3d:AddSkyboxToUniform3D(Engine.i, "res/textures/skybox1/",
                    math.floor(app.Uniforms.SimpleSkyboxUniform.index),
                    1)
